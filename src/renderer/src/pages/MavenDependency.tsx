...
import { Copy, Check, Search, ExternalLink, Globe } from 'lucide-react'
...
const MAVEN_MIRRORS: MavenMirror[] = [
  { id: 'aliyun', name: '阿里云', url: 'https://maven.aliyun.com/repository/public', description: '国内最快，推荐' },
  { id: 'huawei', name: '华为云', url: 'https://repo.huaweicloud.com/repository/maven/', description: '华为云镜像' },
  { id: 'tencent', name: '腾讯云', url: 'https://mirrors.cloud.tencent.com/nexus/repository/maven-public/', description: '腾讯云镜像' },
  { id: 'tsinghua', name: '清华大学', url: 'https://mirrors.tuna.tsinghua.edu.cn/maven2/', description: '清华大学镜像' },
  { id: 'ustc', name: '中科大', url: 'https://mirrors.ustc.edu.cn/maven2/', description: '中科大镜像' }
]
        ...
        {activeTab === 'dependency' ? (
          ...
          <div className="mvn-mirror-section">
            <div className="mvn-mirror-hint">
              <Globe size={14} />
              <span>国内 Maven 镜像源配置，将以下内容添加到 ~/.m2/settings.xml 的 &lt;mirrors&gt; 节点中</span>
            </div>
